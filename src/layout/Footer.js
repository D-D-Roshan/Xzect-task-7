                    ...
                    <Row className="justify-content-center">
                        <Col lg={10} className="text-center">
                            <Navbar.Brand className="logo text-uppercase" href="index-1.html">
                                <img src={logo} className="logo" alt="" height="80" />
                        ...
                        <div className="col-lg-8">
                            <Nav className="list-inline d-sm-flex justify-content-between footer-link mb-0">
                                ...
                                <Nav.Item className="list-inline-item">
                                    <Nav.Link href="#team">Testimonial</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="list-inline-item">
                    ...
                    <Row className="justify-content-center">
                        <Col lg={6}>
                            <p className="mb-0 text-center text-muted">
                                ...
                                <Link to="https://themesdesign.in/" target="_blank" className="text-muted"> Roshan.</Link>
                            </p>
                        </Col>
                    </Row>
                </Container>
