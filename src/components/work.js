          ...
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="work-pra">
                <p className="text-muted">Welcome to Nexa Analytics! Our digital marketing platform is designed to be intuitive and powerful, helping you enhance your online presence and drive business growth. Here's a step-by-step guide on how to get started and make the most out of our features.</p>
                <h4 className="my-4">BENEFITS OF APP</h4>
                <ul className="inline-item">
                  <li className="list-inline-item">
                    <i className="uil uil-signin"></i>
                    <p className="text-muted">Create your account and complete the onboarding process to customize your experience.</p>
                  </li>
                  <li className="list-inline-item">
                    <i className="uil uil-envelope-minus"></i>
                    <p className="text-muted">Integrate your website, social media accounts, and other marketing channels.</p>
                  </li>
                  <li className="list-inline-item">
                    <i className="uil uil-star"></i>
                    <p className="text-muted">Use our tools to analyze content, optimize SEO, and manage social media.</p>
                  </li>
                  <li className="list-inline-item">
                    <i className="uil uil-heart-alt"></i>
                    <p className="text-muted">Monitor your campaigns in real-time and generate reports to measure success.</p>
                  </li>
                </ul>
              </div>
            </Col>
